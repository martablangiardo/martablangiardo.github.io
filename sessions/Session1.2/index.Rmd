...
bibfile=RefManageR::ReadBib("C:/Users/magb/Dropbox/Bayes_Spatial_2025/Material/Session1.2/Biblio.bib",check = FALSE)
...
`r include_fig("venn_diagram.png",width="50%",title="")`
...
kable(df, col.names = c("Event", "A", "A^C", "Total"), "pipe", escape = F, caption = "Prior and likelihood",  booktabs=TRUE) %>% kable_styling(latex_options = "hold_position")
```
---
...
`r include_fig("example_as_bayes_no_values.png",width="75%")`
...
`r include_fig("example_as_bayes_values.png",width="75%")`
...
`r include_fig("Bayes1.png",width="150%",title="")`
]
