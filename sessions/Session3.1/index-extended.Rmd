...
params: 
   ...
   date: ""
   short_title: "MSc in Epidemiology / Health Data Analytics"
output:
...
bibfile=RefManageR::ReadBib("C:/Users/magb/Dropbox/Bayes_Spatial_2024/Material/Session3.1/Biblio.bib",check = FALSE)
...
.pull-right[
`r include_fig("INLA_citations.png",width="40%",title="")`
]
...
legend(10,0.3,lwd=0.5,legend=expression(paste("Gamma(10,0.5)")),bty="n")
...
$$\class{red}{p(\boldsymbol\psi\mid\boldsymbol{y})} \class{black}{= \frac{p(\boldsymbol\theta,\boldsymbol\psi\mid\boldsymbol{y})}{p(\boldsymbol\theta\mid\boldsymbol\psi,\boldsymbol{y})}} \text{ (Recall slide 16)}$$
