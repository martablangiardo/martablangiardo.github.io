...
- Comment the map.
We can see, that the low vaccination uptake is more likely to be in the MSOA with the yellow color, and that the high vaccination uptake is more likely to be in the MSOA with purpole color.
