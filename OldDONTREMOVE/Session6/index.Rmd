---
title: "Session 6: Introduction to geospatial data"
params: 
...
bibfile=RefManageR::ReadBib("C:/Users/magb/Dropbox/Books/INLABook/ShortCourse/VIBASS/Session6/Biblio.bib",check = FALSE)
```
...
`r vspace("10px")`
- `terra` is a successor of the `raster` package. It contains classes and methods representing raster objects (but it has also its own vector data classes). It allows raster data to be loaded, processed and saved.
`r vspace("10px")`
