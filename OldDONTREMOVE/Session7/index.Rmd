---
title: "Session 7: Spatial models for small area data: disease mapping and ecological regression"
params: 
...
bibfile=RefManageR::ReadBib("~/Dropbox/TEACHING/YEAR_2023/Bayes_Spatial_2023/Material/Session7/Biblio.bib",check = FALSE)
```
...
- For PC priors, see:
 - `r Citet(bibfile, "10.1214/16-STS576")`
...
- We need to define $U_1, U_2$ and $\alpha_1, \alpha_2$; following `r Citet(bibfile, "10.1214/16-STS576")`:
`r vspace("10px")`
...
- Therefore, following `r Citet(bibfile, "10.1214/16-STS576")` the priors are as follows:
