---
title: "Session 9.1: Introduction to temporal modelling"
params: 
...
bibfile=RefManageR::ReadBib("~/Dropbox/TEACHING/YEAR_2023/Bayes_Spatial_2023/Material/Session9.1/Biblio.bib",check = FALSE)
```
...
.pull-left[
```{r white-nose, eval=FALSE, echo=TRUE}
...
`r include_fig("RW1-2.png", width="35%", title="")`
