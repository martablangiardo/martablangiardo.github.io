---
title: "Session 4.1: Models for geostatistical data and introduction to SPDE"
params: 
...
- To create the mesh in `R-INLA` we use the helper function `inla.mesh.2d`  with the following options:
`r vspace("20px")`
