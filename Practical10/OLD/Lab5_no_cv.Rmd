...
## 5. Map of the prediction at grid level

* We extract the indices to the prediction nodes and then extract the posterior mean of the response. To do so, we use `inla.stack.index()` function to get the indices of stack that correspond to `tag = "pred"`
